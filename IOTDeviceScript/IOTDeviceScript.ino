...
const char ssid[] = "XXXX"; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "XXXX"; // TODO cambiar por la contraseña de la red WiFi
...
const char MQTT_HOST[] = "52.91.xxx.xxx"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
const int MQTT_PORT = 8082;
const char MQTT_USER[] = USER;
//Contraseña de MQTT
const char MQTT_PASS[] = "PASS"; // TODO Reemplace ContrasenaMQTT por la contraseña correpondiente al usuario especificado.
 ...
 */
void sendSensorData(float temperatura, float humedad,int luminosidad2) {
  Serial.println(luminosidad2);
  String data = "{";
  data += "\"temperatura\": "+ String(temperatura, 1) +", ";
  data += "\"humedad\": "+ String(humedad, 1) +", ";
  data += "\"luminosidad\": "+ String(luminosidad2);
  data += "}";
   Serial.println(data);
...
void receivedCallback(char* topic, byte* payload, unsigned int length) {
  Serial.print("**********************ingreso al receivedCallback**************************************");
